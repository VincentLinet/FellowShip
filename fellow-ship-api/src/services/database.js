...
const insertId = result => (result !== undefined ? result.insertId : undefined);

export const execute = database => executeQuery(database, []);

export const executeSingle = (database, defaultValue) => executeQuery(database, defaultValue, toSingle);

export const insert = database => executeQuery(database, undefined, insertId);
